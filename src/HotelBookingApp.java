 ...
 * in a fair and predictable order. No room allocation or inventory
 ...
 * At this stage, a reservation only captures intent, not
 * confirmation or room allocation.
 */
class Reservation {
 ...
 *
 * Description:
 * This class manages booking requests using a queue to ensure fair
 * allocation. Requests are processed strictly in the order they are received.
 */
class BookingRequestQueue {
